...
#[cfg(windows)]
pub (crate) fn map_os_priority(priority:E_RSM_TASK_PRIORITY)->(i32,u32) {
	let  (policy,sys_pri) = match priority {
	    E_RSM_TASK_PRIORITY::THREAD_PRI_LOW=>(0,Threading::BELOW_NORMAL_PRIORITY_CLASS),
        E_RSM_TASK_PRIORITY::THREAD_PRI_NORMAL=>(0,Threading::NORMAL_PRIORITY_CLASS),
        E_RSM_TASK_PRIORITY::THREAD_PRI_HIGH=>(0,Threading::ABOVE_NORMAL_PRIORITY_CLASS),
        E_RSM_TASK_PRIORITY::THREAD_PRI_REALTIME=>(0,Threading::REALTIME_PRIORITY_CLASS),
        E_RSM_TASK_PRIORITY::THREAD_PRI_REALTIME_HIGH=>(0,Threading::REALTIME_PRIORITY_CLASS),
        E_RSM_TASK_PRIORITY::THREAD_PRI_REALTIME_HIGHEST=>(0,Threading::REALTIME_PRIORITY_CLASS),
        _=>(0,Threading::ABOVE_NORMAL_PRIORITY_CLASS),
	};
...
pub (crate)fn map_os_priority(priority:E_RSM_TASK_PRIORITY)->(i32,i32) {
	let  (policy,sys_pri) = match priority {
        ...
        E_RSM_TASK_PRIORITY::THREAD_PRI_NORMAL=>(libc::SCHED_OTHER,0),
        E_RSM_TASK_PRIORITY::THREAD_PRI_HIGH=>(libc::SCHED_OTHER,0),
